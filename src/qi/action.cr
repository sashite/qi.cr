module Qi
  ...
  class Action
    @src_square_id : Int32?
    @dst_square_id : Int32
    @moved_piece_name : String
    @captured_piece_name : String?
    ...
    def initialize(src_square_id : Int32?, dst_square_id : Int32, moved_piece_name : String, captured_piece_name : String? = nil)
    ...
    def call(*, in_hand : Array(String), square : Hash(Int32, String))
      ...
      in_hand += [@captured_piece_name.as(String)] unless @captured_piece_name.nil?

      {in_hand: in_hand.as(Array(String)), square: square.as(Hash(Int32, String))}
    end
  end
end
